...
function hashSchema(schema) {
    return hashContent(graphql.print(pluginHelpers.getCachedDocumentNodeFromSchema(schema)));
}
...
const { writeFile: fsWriteFile, readFile: fsReadFile, stat: fsStat } = fs.promises;
...
async function generate(input, saveToFile = true) {
    ...
    if (context.profilerOutput) {
        await writeFile(path.join(context.cwd, context.profilerOutput), JSON.stringify(context.profiler.collect()));
    }
    return outputFiles;
}
