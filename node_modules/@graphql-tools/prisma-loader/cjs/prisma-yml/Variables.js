...
// @ts-ignore
const replaceall_1 = tslib_1.__importDefault(require("replaceall"));
...
class Variables {
    ...
    populateVariable(propertyParam, matchedString, valueToPopulate) {
        ...
        if (typeof valueToPopulate === 'string') {
            property = (0, replaceall_1.default)(matchedString, valueToPopulate, property);
        }
        else {
            if (property !== matchedString) {
                if (typeof valueToPopulate === 'number') {
                    property = (0, replaceall_1.default)(matchedString, String(valueToPopulate), property);
                }
                else {
                    const errorMessage = [
