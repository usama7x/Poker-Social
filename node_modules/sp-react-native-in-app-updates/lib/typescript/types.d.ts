export declare enum AndroidInstallStatus {
    UNKNOWN = 0,
    PENDING = 1,
    DOWNLOADING = 2,
    INSTALLING = 3,
...
export declare type InstallationResult = AndroidInstallStatus.INSTALLED | AndroidInstallStatus.CANCELED;
export declare type StatusUpdateEvent = {
    bytesDownloaded: any;
...
export declare type SemverVersionCode = number;
export interface NeedsUpdateResponseBase {
    shouldUpdate: boolean;
    storeVersion: SemverVersion;
    reason: string;
}
export declare enum AndroidOther {
    IN_APP_UPDATE_RESULT_KEY = "in_app_update_result",
    IN_APP_UPDATE_STATUS_KEY = "in_app_update_status"
}
export declare enum AndroidAvailabilityStatus {
    UNKNOWN = 0,
    AVAILABLE = 2,
    UNAVAILABLE = 1,
    DEVELOPER_TRIGGERED = 3
}
export declare enum AndroidUpdateType {
    FLEXIBLE = 0,
    IMMEDIATE = 1
}
export declare type AndroidInAppUpdateExtras = {
...
export declare type AndroidStatusEventListener = (status: StatusUpdateEvent) => void;
export declare type AndroidIntentResultListener = (intentResult: InstallationResult) => void;
export declare type AndroidStartUpdateOptions = {
    updateType: AndroidUpdateType;
};
export declare type IosITunesResponse = {
...
export declare type NeedsUpdateResponse = IosNeedsUpdateResponse | AndroidNeedsUpdateResponse;
declare type IosStartUpdateOption = {
    title?: string;
    message?: string;
...
declare type IosStartUpdateOptionWithLocalVersion = IosStartUpdateOption & {
    localVersion: string;
};
export declare type IosStartUpdateOptions = IosStartUpdateOption & {
    versionSpecificOptions?: Array<IosStartUpdateOptionWithLocalVersion>;
};
export declare type StartUpdateOptions = IosStartUpdateOptions | AndroidStartUpdateOptions;
export {};
